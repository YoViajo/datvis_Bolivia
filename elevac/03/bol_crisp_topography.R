## Ref: https://milospopovic.net/crisp-topography-map-with-r/
...
get_elevation_map <- function(country_map) {
  ...
  country_map <- ggplot() +
    ...
    labs(x = "", 
         y = NULL, 
         title = "Mapa topográfico de BOLIVIA", 
         subtitle = "", 
...
ggsave(filename="bolivia_topo_map.png", width=7, height=8.5, dpi = 400, device='png', country_map)
